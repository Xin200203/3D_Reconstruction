...
# 在 TinySA Online 配置上启用 BiFusionEncoder，并添加 LoadClipFeature。

_base_ = ['./ESAM_online_3dtsa_scannet.py']
...
# batch size / memory queue 调整示例，可按需覆盖
train_dataloader = dict(batch_size=4)
model.update(memory=dict(queue=-1)) 