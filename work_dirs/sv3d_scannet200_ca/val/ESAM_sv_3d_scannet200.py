...
launcher = 'none'
load_from = 'work_dirs/sv3d_scannet200/best_all_ap_50%_epoch_128.pth'
...
model = dict(
    backbone=dict(
        ...
        in_channels=3,
        init_cfg=dict(
            checkpoint='work_dirs/tmp/ESAM-E_online_epoch_128.pth',
            prefix='backbone',
            type='Pretrained'),
        out_channels=96,
        type='Res16UNet34C'),
...
work_dir = 'work_dirs/sv3d_scannet200/val'
