...
log_config = dict(
    hooks=[
        ...
        dict(by_epoch=False, type='TensorboardLoggerHook'),
    ],
    interval=5)
log_level = 'INFO'
log_processor = dict(
...
model = dict(
    auxiliary_losses=dict(
        spatial_consistency=dict(
            k_neighbors=8, loss_weight=0.02, type='SpatialConsistencyLoss')),
    backbone=dict(
        config=dict(
    ...
    criterion=dict(
        auxiliary_losses=dict(spatial_consistency=dict(loss_weight=0.02)),
        clip_criterion=dict(loss_weight=0.1),
        inst_criterion=dict(
    ...
    decode_head=dict(loss_weight=0.1),
    decoder=dict(
        activation_fn='gelu',
        attn_mask=True,
        cross_attn_mode=[
...
vis_backends = [
    ...
    dict(
        save_dir='./work_dirs/tensorboard_logs', type='TensorboardVisBackend'),
]
visualizer = dict(
    _scope_='mmdet3d',
    name='visualizer',
...
work_dir = 'work_dirs/bifusion_stage2_optimized'
