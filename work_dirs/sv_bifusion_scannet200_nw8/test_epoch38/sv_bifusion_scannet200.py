...
_cfg_dir = '/home/nebula/xxy/ESAM/configs/ESAM_CA'
backend_args = None
class_names = [
    'wall',
    'floor',
...
launcher = 'none'
load_from = '/home/nebula/xxy/ESAM/work_dirs/sv_bifusion_scannet200_nw8/epoch_38.pth'
log_level = 'INFO'
log_processor = dict(
...
model = dict(
    ...
    criterion=dict(
        ...
        sem_criterion=dict(
            ignore_index=200, loss_weight=0.5,
...
optim_wrapper = dict(
    ...
    paramwise_cfg=dict(custom_keys=dict(pos_embed=dict(lr_mult=0.1))),
    type='OptimWrapper')
...
work_dir = 'work_dirs/sv_bifusion_scannet200_nw8/test_epoch38'
